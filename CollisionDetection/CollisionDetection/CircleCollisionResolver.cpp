...
bool CircleCollisionResolver::isCollision(const CirclePhysics& s1, const CirclePhysics& s2)
{
...
void CircleCollisionResolver::resolve(CirclePhysics* s1, CirclePhysics* s2, float duration)
{
	resolve(s1, s2, duration, 1.0f);
}

void CircleCollisionResolver::resolve(CirclePhysics* s1, CirclePhysics* s2, float duration, float restitution)
{
