...
SphereGeometry::SphereGeometry(Sphere initialState)
{
...
void SphereGeometry::update(const float& duration)
{
	if (isMovable() == false) 
		return;
...
void SphereGeometry::addForce(const Vector2& force)
{
	sphere.totalForce += force;
}

void SphereGeometry::clearForce()
{
	sphere.totalForce.x = 0.0f;
	sphere.totalForce.y = 0.0f;
}

void SphereGeometry::resolveBorder(const int& width, const int& height)
{
...
void SphereGeometry::resolveOverlap(const SphereGeometry& s)
{
...
bool SphereGeometry::isMovable() const
{
	return inverseMass() > 0.0f;
}

float SphereGeometry::inverseMass() const
{
	return 1.0f / sphere.mass;
}

float SphereGeometry::mass() const
{
	return sphere.mass;
}
...
Vector2 SphereGeometry::position() const
{
	return sphere.position;
}

Vector2 SphereGeometry::velocity() const
{
	return sphere.velocity;
}

int SphereGeometry::colour(const char& col)
{
	if (col == 'r' || col == 'R')
